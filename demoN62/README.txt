...
a persistence unit "demoN62PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoN62/pom.xml":
...
artifact ("demoN62.war") is already built. You can build
